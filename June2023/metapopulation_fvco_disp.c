...
if(reals==1){
	...
	//********FIXED PARAMS***********
		//INITIAL CONDITIONS
		//meta1
		Params.FITINIT[1][0] = 10; //initS //FX
		Params.FITINIT[1][1] = 10; //initS //FX
		Params.FITINIT[1][2] = 10; //initS //FX
		Params.FITINIT[1][3] = 10; //initS //FX

		Params.FITINIT[1][4] = 0; //initV //fonly //FX
		Params.FITINIT[1][5] = 0.2; //initV  //FX
		Params.FITINIT[1][6] = 0.2; //initV //FX
		Params.FITINIT[1][7] = 00; //initV //control //FX
		...
		//meta2
		Params.FITINIT[2][0] = 10; //initS  //FX
		Params.FITINIT[2][1] = 10; //initS //FX
		Params.FITINIT[2][2] = 10; //initS //FX
		Params.FITINIT[2][3] = 10; //initS //FX
		...
		//meta3
		Params.FITINIT[3][0] = 10; //initS //FX
		Params.FITINIT[3][1] = 10; //initS //FX
		Params.FITINIT[3][2] = 10; //initS //FX
		Params.FITINIT[3][3] = 10; //initS //FX
		...
		//meta1
		Params.FITINIT[1][8] = 0; //initR //fonly  //FT* //0.000726
		//meta2
		Params.FITINIT[2][8] = 	0; //initR //fonly //FX //0.001749
		Params.FITINIT[2][9] = 0; //initR //vonly //FX
		Params.FITINIT[2][10] = 0; //initR //fv //FX
		Params.FITINIT[2][11] = 0; //initR //control //FX
		//meta3
		Params.FITINIT[3][8] = 0; //initR //fonly //0.00226
		Params.FITINIT[3][9] = 0; //initR //vonly
		Params.FITINIT[3][10] = 0; //initR //fv
		Params.FITINIT[3][11] = 0; //initR //control

		//VIRUS //3
		Params.muV			= 0.2; //Fuller 2012 //virus decay //0.39
		Params.CV			= 0.086; //hetereogeneity to virus infection //previously 0.86
		Params.nuV    		= 0.4; //virus transmission
