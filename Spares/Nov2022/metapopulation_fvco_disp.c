...
if(reals==1){
	...
	Params.FITINIT[1][4] = 1e-11; 				//initV //fonly
	Params.FITINIT[1][5] = 0.2; //initV
	Params.FITINIT[1][6] = 0.2; //initV
	Params.FITINIT[1][7] = 1e-11;				//initV //control
	Params.FITINIT[1][8] = 0.001889; //initR
	Params.FITINIT[1][9] = 0.001889; //initR
	Params.FITINIT[1][10] = 0.001889; //initR
	Params.FITINIT[1][11] = 0.001889; //initR
	...
	Params.FITINIT[2][4] = 1e-11; 				//initV //fonly
	Params.FITINIT[2][5] = 0.2; //initV
	Params.FITINIT[2][6] = 0.2; //initV
	Params.FITINIT[2][7] = 1e-11; 				//initV //control
	Params.FITINIT[2][8] = 0.001889; //initR
	Params.FITINIT[2][9] = 0.001889;//initR
	Params.FITINIT[2][10] = 0.001889; //initR
	Params.FITINIT[2][11] = 0.001889; //initR
	...
	Params.FITINIT[3][4] = 1e-11; 				//initV //f only
	Params.FITINIT[3][5] = 0.2; //initV
	Params.FITINIT[3][6] = 0.2; //initV
	Params.FITINIT[3][7] = 1e-11;				 //initV //control
	Params.FITINIT[3][8] = 0.001889; //initR
	Params.FITINIT[3][9] = 0.001889; //initR
	Params.FITINIT[3][10] = 0.001889; //initR
	Params.FITINIT[3][11] = 0.001889; //initR

	//metapopultion four
	Params.FITINIT[4][0] = 41.00000; //initS
	Params.FITINIT[4][4] = 0.143934; //initV
	Params.FITINIT[4][8] = 	0.001889; //initR

	//metapopultion five
	Params.FITINIT[5][0] = 27.969236; //initS
	Params.FITINIT[5][4] = 0.320229; //initV
	Params.FITINIT[5][8] = 1e-15; //initR

	//metapopultion six
	Params.FITINIT[6][0] = 3.000000; //initS
	Params.FITINIT[6][4] = 0.128848; //initV
	Params.FITINIT[6][8] = 0.005471; //initR

	//dispersal parameters
	Params.con_mgr 		= 0;
	Params.a 			= 0.001;
	Params.lar_mgr 		= .2; //0-1
	Params.a2			= 0.001; //0-0.3 (smaller numbers more migration)

	//coinfection parameters
	Params.coinf_V		= 0.498190;
	Params.VFSus		= 1.000000;

	//stochasticity parameters
	Params.Rsd_exp 		= 0.900000;
	Params.Fsd_exp		= 0.000000;
	Params.Rsd_obs		= 0.937263;
	Params.Fsd_obs		= 1.512209;
