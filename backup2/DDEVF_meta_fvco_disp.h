...
//double ave_R = Params->PARS[50+pop];//TRIAL 2
...
//double FIO_Cc; TRIAL 2
//double FIO_Cr;TRIAL 2
//double FIO_Oc;TRIAL 2
//double FIO_Or;TRIAL 2
...
//double ConiBefore=0.0;    //CK// Thing to store conidia the day before the feral collection //TRIAL 3
//double RestBefore=0.0;    //CK// Thing to store resting spores the day before the feral collection //TRIAL 3
...
//double Vstart = ratio*initV;		TRIAL 2				// viral cadavers after infected neonates die //SH need to make 4x?
