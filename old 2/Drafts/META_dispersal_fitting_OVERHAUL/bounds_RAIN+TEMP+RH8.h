...
// ------------------------------------------------------------------------------------------- //
void load_fxd_parms(void *Paramstruct,int numb)
{
STRUCTURE* Params;
...
void global_fixed_parms(void *Paramstruct)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
...
// ---------------------------------------------------------------------------------------------------------------- //
void parm_range_inc(void *Paramstruct,double parm_inc,double host_inc,double initR_inc,int num_adj_pars)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
...
// ---------------------------------------------------------------------------------------------------------------- //
void random_restart_parms(void *Paramstruct,gsl_rng *r_seed,int num_adj_pars,int test,int pro)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
