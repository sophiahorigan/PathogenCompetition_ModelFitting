...
//metapopulation one
if (i==0)			{	low = 80;			high = 120;		}	//initS fungus-only
else if (i==1)		{	low = 80;			high = 120;		}	//initS virus-only
else if (i==2)		{	low = 80;			high = 120;		}	//initS fungus-virus
else if (i==3)		{	low = 80;			high = 120;		}	//initS control
...
//metapopulation two
else if (i==12)		{	low = 80;			high = 120;		}	//initS fungus-only
else if (i==13)		{	low = 80;			high = 120;		}	//initS virus-only
else if (i==14)		{	low = 80;			high = 120;		}	//initS fungus-virus
else if (i==15)		{	low = 80;			high = 120;		}	//initS control
...
else if (i==24)		{	low = 80;			high = 120;		}	//initS fungus-only
else if (i==25)		{	low = 80;			high = 120;		}	//initS virus-only
else if (i==26)		{	low = 80;			high = 120;		}	//initS fungus-virus
else if (i==27)		{	low = 80;			high = 120;		}	//initS control
