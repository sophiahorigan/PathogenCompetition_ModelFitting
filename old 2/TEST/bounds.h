...
else if (i==1)		{	low = 1e-5;			high = 100;		}	//initS virus-only
else if (i==2)		{	low = 1e-5;			high = 100;		}	//initS fungus-virus
else if (i==3)		{	low = 1e-5;			high = 100;		}	//initS control
...
//metapopulation two
else if (i==12)		{	low = 1e-5;			high = 100;		}	//initS fungus-only
else if (i==13)		{	low = 1e-5;			high = 100;		}	//initS virus-only
else if (i==14)		{	low = 1e-5;			high = 100;		}	//initS fungus-virus
else if (i==15)		{	low = 1e-5;			high = 100;		}	//initS control
...
else if (i==24)		{	low = 1e-5;			high = 100;		}	//initS fungus-only
else if (i==25)		{	low = 1e-5;			high = 100;		}	//initS virus-only
else if (i==26)		{	low = 1e-5;			high = 100;		}	//initS fungus-virus
else if (i==27)		{	low = 1e-5;			high = 100;		}	//initS control
...
//metapopulation six
else if (i==42)		{	low = 1e-5;			high = 200;		} 	//initS
else if (i==43)		{	low = 0;			high = 0.5;		} 	//initV
else if (i==44)		{	low = 0;			high = 0.01;	} 	//initR

//conidia dispersal
else if (i==45)		{	low = 0;			high = 1;		} 	//con_mgr //rate of conidia dispersal
else if (i==46)		{	low = 0;			high = .5;		}	//a //distance dispersal parameter conidia

//larval dispersal
//meta 1
else if (i==47)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==48)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==49)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==50)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal

else if (i==51)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==52)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==53)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==54)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae

//meta 2
else if (i==55)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==56)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==57)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==58)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal

else if (i==59)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==60)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==61)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==62)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae

//meta 3
else if (i==63)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==64)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==65)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal
else if (i==66)		{	low = 0;			high = 10;		}	//lar_mgr //rate of larval dispersal

else if (i==67)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==68)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==69)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae
else if (i==70)		{	low = 0;			high = .5;		} 	//a2 //distance dispersal parameter larvae

//coifection
else if (i==71) 	{	low = 0;			high = 1;		}	//coinf_V //coinfecteds produce what proportion of OBs/conidia
else if (i==72) 	{	low = 0;			high = 50;		}	//VFSus //enhanced susceptibility 

//stochasticity
else if (i==73)		{	low = 0;			high = 2;		}	//Rsd_exp
else if (i==74)		{	low = 0;			high = 2;		}	//Fsd_exp
else if (i==75)		{	low = 0;			high = 2;		}	//Rsd_obs
...
//conidia dispersal
//meta 1
else if (i==80)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==81)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==82)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==83)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal

else if (i==84)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==85)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==86)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==87)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia

//meta 2
else if (i==88)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==89)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==90)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==91)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal

else if (i==92)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==93)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==94)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==95)		{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia

//meta 3
else if (i==96)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==97)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==98)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal
else if (i==99)		{	low = 0;			high = 10;		}	//con_mgr //rate of conidia dispersal

else if (i==100)	{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==101)	{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==102)	{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
else if (i==103)	{	low = 0;			high = .5;		} 	//a //distance dispersal parameter conidia
...
//larval dispersal
//meta 1
else if (i==47)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==48)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==49)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==50)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal

else if (i==51)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==52)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==53)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==54)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae

//meta 2
else if (i==55)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==56)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==57)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==58)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal

else if (i==59)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==60)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==61)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==62)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae

//meta 3
else if (i==63)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==64)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==65)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal
else if (i==66)		{	step_size = 0.25;	}	//lar_mgr //rate of larval dispersal

else if (i==67)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==68)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==69)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae
else if (i==70)		{	step_size = 0.005;	} 	//a2 //distance dispersal parameter larvae

//coifection
else if (i==71) 	{	step_size = .01;	}	//coinf_V //coinfecteds produce what proportion of OBs/conidia
else if (i==72) 	{	step_size = 2;	}	//VFSus //enhanced susceptibility 

//stochasticity
else if (i==73)		{	step_size = .1;	}	//Rsd_exp
else if (i==74)		{	step_size = .1;	}	//Fsd_exp
else if (i==75)		{	step_size = .1;	}	//Rsd_obs
...
else if (i==79)		{	step_size = 0.00005;	}	//fungus transmission

//conidia dispersal
//meta 1
else if (i==80)		{	step_size = 0.5;	}	//con_mgr //rate of conidia dispersal
else if (i==81)		{	step_size = 0.5;	}	
else if (i==82)		{	step_size = 0.5;	}	
else if (i==83)		{	step_size = 0.5;	}	

else if (i==84)		{	step_size = 0.005;	} 	//a //distance dispersal parameter conidia
else if (i==85)		{	step_size = 0.005;	} 	
else if (i==86)		{	step_size = 0.005;	} 	
else if (i==87)		{	step_size = 0.005;	} 	

//meta 2
else if (i==88)		{	step_size = 0.5;	}	//con_mgr //rate of conidia dispersal
else if (i==89)		{	step_size = 0.5;	}	
else if (i==90)		{	step_size = 0.5;	}	
else if (i==91)		{	step_size = 0.5;	}	

else if (i==92)		{	step_size = 0.005;	} 	//a //distance dispersal parameter conidia
else if (i==93)		{	step_size = 0.005;	} 	
else if (i==94)		{	step_size = 0.005;	} 	
else if (i==95)		{	step_size = 0.005;	} 	

//meta 3
else if (i==96)		{	step_size = 0.5;	}	//con_mgr //rate of conidia dispersal
else if (i==97)		{	step_size = 0.5;	}	
else if (i==98)		{	step_size = 0.5;	}	
else if (i==99)		{	step_size = 0.5;	}	

else if (i==100)	{	step_size = 0.005;	} 	//a //distance dispersal parameter conidia
else if (i==101)	{	step_size = 0.005;	} 	
else if (i==102)	{	step_size = 0.005;	} 	
else if (i==103)	{	step_size = 0.005;	} 	
...
//larval dispersal
//meta 1
else if (i==47)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal
else if (i==48)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal
else if (i==49)		{	low = 0;			high = 10000;	}	//lar_mgr //rate of larval dispersal
else if (i==50)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal

else if (i==51)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==52)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==53)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==54)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae

//meta 2
else if (i==55)		{	low = 0;			high = 10000;	}	//lar_mgr //rate of larval dispersal
else if (i==56)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal
else if (i==57)		{	low = 0;			high = 10000;	}	//lar_mgr //rate of larval dispersal
else if (i==58)		{	low = 0;			high = 10000;			}	//lar_mgr //rate of larval dispersal

else if (i==59)		{	low = 0;			high = 1;			} 	//a2 //distance dispersal parameter larvae
else if (i==60)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==61)		{	low = 0;			high = 1;			} 	//a2 //distance dispersal parameter larvae
else if (i==62)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae

//meta 3
else if (i==63)		{	low = 0;			high = 10000;			}	//lar_mgr //rate of larval dispersal
else if (i==64)		{	low = 0;			high = 10000;			}	//lar_mgr //rate of larval dispersal
else if (i==65)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal
else if (i==66)		{	low = 0;			high = 10000;		}	//lar_mgr //rate of larval dispersal

else if (i==67)		{	low = 0;			high = 1;			} 	//a2 //distance dispersal parameter larvae
else if (i==68)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==69)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
else if (i==70)		{	low = 0;			high = 1;		} 	//a2 //distance dispersal parameter larvae
...
//conidia dispersal
//meta 1
else if (i==80)		{	low = 0;			high = 10000;		}	//con_mgr //rate of conidia dispersal
else if (i==81)		{	low = 0;			high = 10000;		}	//con_mgr //rate of conidia dispersal
else if (i==82)		{	low = 0;			high = 10000;		}	
else if (i==83)		{	low = 0;			high = 10000;		}	

else if (i==84)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==85)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==86)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==87)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia

//meta 2
else if (i==88)		{	low = 0;			high = 10000;	}	//con_mgr //rate of conidia dispersal
else if (i==89)		{	low = 0;			high = 10000;	}	
else if (i==90)		{	low = 0;			high = 10000;	}	
else if (i==91)		{	low = 0;			high = 10000;	}	

else if (i==92)		{	low = 0;			high = 1;			} 	//a //distance dispersal parameter conidia
else if (i==93)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==94)		{	low = 0;			high = 1;			} 	//a //distance dispersal parameter conidia
else if (i==95)		{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia

//meta 3
else if (i==96)		{	low = 0;			high = 10000;			}	//con_mgr //rate of conidia dispersal
else if (i==97)		{	low = 0;			high = 10000;			}	//con_mgr //rate of conidia dispersal
else if (i==98)		{	low = 0;			high = 10000;		}	//con_mgr //rate of conidia dispersal
else if (i==99)		{	low = 0;			high = 10000;		}	//con_mgr //rate of conidia dispersal

else if (i==100)	{	low = 0;			high = 1;			} 	//a //distance dispersal parameter conidia
else if (i==101)	{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==102)	{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
else if (i==103)	{	low = 0;			high = 1;		} 	//a //distance dispersal parameter conidia
