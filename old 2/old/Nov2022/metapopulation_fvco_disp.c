...
if(reals==1){
	...
	Params.FITINIT[2][11] = 0.00100; //initR
	...
	Params.FITINIT[3][8] = 0.002000; //initR
	Params.FITINIT[3][9] = 0.001000; //initR
	Params.FITINIT[3][10] = 0.001000; //initR
	Params.FITINIT[3][11] = 0.002500; //initR

	//metapopultion four
	Params.FITINIT[4][0] = 36.00000; //initS
	Params.FITINIT[4][4] = 0.104042; //initV
	Params.FITINIT[4][8] = 	0.002000; //initR

	//metapopultion five
	Params.FITINIT[5][0] = 20.52150; //initS
	Params.FITINIT[5][4] = 0.200000; //initV
	Params.FITINIT[5][8] = 0.0000000000000000001; //initR

	//metapopultion six
	Params.FITINIT[6][0] = 40.198079; //initS
	Params.FITINIT[6][4] = 0.455802; //initV
	Params.FITINIT[6][8] = 0.008971; //initR

	//dispersal parameters
	Params.con_mgr 		= 1.000000;
	Params.a 			= 0.444937;
	Params.lar_mgr 		= 1.000000;
	Params.a2			= 0.064872;

	//coinfection parameters
	Params.coinf_V		= 0.010000;
	Params.VFSus		= 2.000000;

	//stochasticity parameters
	Params.Rsd_exp 		= 0.200000;
	Params.Fsd_exp		= 1.200000;
	Params.Rsd_obs		= 0.600000;
...
for (round=0;round<numround;round++){
	...
	while (a<num_ltfparams){    
		...
		if (a != 4 | a != 5 | a != 6 | a != 7 | a != 9 | a != 10 | a != 11 | a != 16 | a != 17 | a != 18 | a != 19 | a != 16 | a != 28 | a != 29 | a != 30 | a != 31 | a != 41){
		//observationals
