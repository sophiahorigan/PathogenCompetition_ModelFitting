...
// ----------------------------------------------------------------------------------------------------- //
double prior_func(void *Paramstruct)
{
STRUCTURE* Params;
...
// ---------------------------------------------------------------------------------------------------- //
void translate_parms_gamma(void *Paramstruct,int size_parm_index,int *parm_index,double *pc_parms)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
...
// ---------------------------------------------------------------------------------------------------- //
void translate_parms(void *Paramstruct,int size_parm_index,int size_S0_index,int size_r0_index,int *parm_index,int *S0_index,int *r0_index,double *pc_parms)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
...
// ---------------------------------------------------------------------------------------------------- //
void testing_parms(void *Paramstruct)
{
STRUCTURE* Params;
Params = (STRUCTURE*) Paramstruct;
int j;
