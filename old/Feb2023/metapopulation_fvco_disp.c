...
if(reals==1){
	...
	Params.FITINIT[2][8] = 0.002500; //initR
	Params.FITINIT[2][9] = 0.002620;//initR
	Params.FITINIT[2][10] = 0.003500; //initR
	Params.FITINIT[2][11] = 0.003995; //initR
	...
	Params.FITINIT[3][8] = 0.003000; //initR
	Params.FITINIT[3][9] = 0.002000; //initR
	Params.FITINIT[3][10] = 0.002474; //initR
	Params.FITINIT[3][11] = 0.000668; //initR

	//metapopultion four
	Params.FITINIT[4][0] = 103.90384; //initS
	Params.FITINIT[4][4] = 0.450000; //initV
	Params.FITINIT[4][8] = 0.000500; //initR

	//metapopultion five
	Params.FITINIT[5][0] = 79.365199; //initS
	Params.FITINIT[5][4] = 0.450000; //initV
	Params.FITINIT[5][8] = 1e-15; //initR //fixed

	//metapopultion six
	Params.FITINIT[6][0] = 196.919548; //initS
	Params.FITINIT[6][4] = 0.232437; //initV
	Params.FITINIT[6][8] = 0.003464; //initR

	//conidia dispersal
	//not used rn
	Params.m_c_pop = 0;
	Params.a_c_pop = 0.944495;

	//larval dispersal
	//meta 1
	Params.m_l_sub[1][0] = 2.034256;
	Params.m_l_sub[1][1] = 0.024844;
	Params.m_l_sub[1][2] = 1.132349;
	Params.m_l_sub[1][3] = 0.000200;
	Params.a_l_sub[1][0] = 0;
	Params.a_l_sub[1][1] = 0;
	Params.a_l_sub[1][2] = 0;
	Params.a_l_sub[1][3] = 0;
	//meta2
	Params.m_l_sub[2][0] = 2.833806;
	Params.m_l_sub[2][1] = 0.000200;
	Params.m_l_sub[2][2] = 0.000200;
	Params.m_l_sub[2][3] = 0.000200;
	Params.a_l_sub[2][0] = 0;
	Params.a_l_sub[2][1] = 0;
	Params.a_l_sub[2][2] = 0;
	Params.a_l_sub[2][3] = 0;
	//meta3
	Params.m_l_sub[3][0] = 0.993265;
	Params.m_l_sub[3][1] = 0.125406;
	Params.m_l_sub[3][2] = 0.050200;
	Params.m_l_sub[3][3] = 0.000200;
	...
	Params.coinf_V		= 0.871177;
	Params.VFSus		= 12.625024;

	//stochasticity parameters
	Params.Rsd_exp 		= 0.922393;
	Params.Fsd_exp		= 2.000000;
	Params.Rsd_obs		= 0.922393; //same bc only fitting one set of stochasticity paramaters
	...
	//conidia dispersal
	//meta 1
	Params.m_c_sub[1][0] = 0.466465;
	Params.m_c_sub[1][1] = 1.869389;
	Params.m_c_sub[1][2] = 1.169292;
	Params.m_c_sub[1][3] = 0.562874;
	Params.a_c_sub[1][0] = 0;
	Params.a_c_sub[1][1] = 0;
	Params.a_c_sub[1][2] = 0;
	Params.a_c_sub[1][3] = 0;
	//meta2
	Params.m_c_sub[2][0] = 3.001895;
	Params.m_c_sub[2][1] = 1.541820;
	Params.m_c_sub[2][2] = 1.018022;
	Params.m_c_sub[2][3] = 0.546386;
	Params.a_c_sub[2][0] = 0;
	Params.a_c_sub[2][1] = 0;
	Params.a_c_sub[2][2] = 0;
	Params.a_c_sub[2][3] = 0;
	//meta3
	Params.m_c_sub[3][0] = 0.609048;
	Params.m_c_sub[3][1] = 0.193586;
	Params.m_c_sub[3][2] = 2.152877;
	Params.m_c_sub[3][3] = 0.269759;
...
for (round=0;round<numround;round++){
	...
	while (a<num_ltfparams){    
		//all
		//if (a != 4 | a != 7 | a != 9 | a != 10 | a != 11 | a != 16 | a != 19 | a != 28 | a != 31 | a != 41 | a!= 45 | a!= 51 | a!= 52 | a!= 53 | a!= 54 | a!= 59 | a!= 60 | a!= 61 | a!= 62 | a!= 67 | a!= 68 | a!= 69 | a!= 70 | a != 75 | a != 76 | a!=77 | a!= 84 | a!= 85 | a!= 86 | a!= 87 | a!= 92 | a!= 93 | a!= 94 | a!= 95 | a!= 100 | a!= 101 | a!= 102 | a!= 103 | a!= 104){
		//separate m's
	...
	//prints subset
	int print_len = 28;
	//int printlist[68] = {0,1,2,3,5,6,8,12,13,14, 15,17,18,20,21,22,23,24,25,26, 27,29,30,32,33,34,35,36,37,38, 39,40,42,43,44,46,47,48,49,50, 55,56,57,58,63,64,65,66,71,72, 73,74,78,79,80,81,82,83,88, 89,90,91,96,97,98,99,105, 106};
