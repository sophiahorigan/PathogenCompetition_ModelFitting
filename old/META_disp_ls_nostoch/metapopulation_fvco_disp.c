...
int round;
int numround = 3; //why do we have rounds?
...
for (i=0;i<num_ltfparams;i++){ //give random initial value for each parameter
    ...
    else if (i==3){ltf_params[i]=1+randn*99;} 		//initS		1 - 20
	...
	else if (i==37){ltf_params[i]=0+randn*0.5;}		//initV		0 - 0.2
	else if (i==38){ltf_params[i]=0+randn*.01;}		//initR		0 - 0.01
	//meta5
	else if (i==39){ltf_params[i]=1+randn*19;} 	//initS		1 - 100
	else if (i==40){ltf_params[i]=0+randn*0.2;}		//initV		0 - 0.5
...
//sprintf(namel,"line_search_likelihood_%d", pid);
	...
	//while (x<len_paramfit){
		...
		if (b>0){
			if (a==0){          //initS
				...
				if (ltf_params[a]>0.5){ltf_params[a]=0.5;}		//upper bound //this is unnecessary so long as the step size is congruent
			}
			else if (a==5){     //initV
				ltf_params[a]=ltf_params[a]+0.05;
				...
				ltf_params[a]=ltf_params[a]+0.05;
				if (ltf_params[a]>1){ltf_params[a]=0.5;}
			}
			else if (a==8){     //initR
				...
				ltf_params[a]=ltf_params[a]+0.05;
				if (ltf_params[a]>0.5){ltf_params[a]=0.5;}		//upper bound
			}
			else if (a==17){     //initV
				ltf_params[a]=ltf_params[a]+0.05;
				if (ltf_params[a]>0.5){ltf_params[a]=0.5;}
...
//all
fprintf(fpv, "%lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\n", maxlhood, ltf_params[0], ltf_params[1], ltf_params[2], ltf_params[3], ltf_params[4], ltf_params[5], ltf_params[6], ltf_params[7], ltf_params[8], ltf_params[9], ltf_params[10], ltf_params[11], ltf_params[12], ltf_params[13], ltf_params[14], ltf_params[15], ltf_params[16], ltf_params[17], ltf_params[18], ltf_params[19], ltf_params[20], ltf_params[21], ltf_params[22], ltf_params[23], ltf_params[24], ltf_params[25], ltf_params[26], ltf_params[27], ltf_params[28], ltf_params[29], ltf_params[30], ltf_params[31], ltf_params[32], ltf_params[33], ltf_params[34], ltf_params[35], ltf_params[36], ltf_params[37], ltf_params[38], ltf_params[39], ltf_params[40], ltf_params[41], ltf_params[42], ltf_params[43], ltf_params[44], ltf_params[45], ltf_params[46], ltf_params[47],ltf_params[48], ltf_params[49]);

//fprintf(fpv, "%lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\t %lf\n", maxlhood, ltf_params[12], ltf_params[13],ltf_params[14],ltf_params[15],ltf_params[16],ltf_params[17],ltf_params[18],ltf_params[19],ltf_params[20],ltf_params[21],ltf_params[22],ltf_params[23], ltf_params[45], ltf_params[46], ltf_params[47], ltf_params[48], ltf_params[49]);
//fclose(fpl);
fclose(fpv);
