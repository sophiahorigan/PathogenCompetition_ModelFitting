...
//metapopulation one
if (i==0)			{	low = 1;			high = 2;		}	//initS fungus-only
else if (i==1)		{	low = 1;			high = 2;		}	//initS virus-only
else if (i==2)		{	low = 1;			high = 2;		}	//initS fungus-virus
else if (i==3)		{	low = 1;			high = 2;		}	//initS control

else if (i==4)		{	low = -4;			high = -3;		}	//initV fungus-only
else if (i==5)		{	low = -4;			high = -1.3;	}	//initV virus-only
else if (i==6)		{	low = -4;			high = -1.3;	}	//initV fungus-virus
else if (i==7)		{	low = -4;			high = -3;		}	//initV control

else if (i==8)		{	low = -4;			high = -2;		}	//initR fungus-only
else if (i==9)		{	low = -4;			high = -2;		}	//initR virus-only
else if (i==10)		{	low = -4;			high = -2;		}	//initR fungus-virus
else if (i==11)		{	low = -4;			high = -2;		}	//initR control

//metapopulation two
else if (i==12)		{	low = 1;			high = 2;		}	//initS fungus-only
else if (i==13)		{	low = 1;			high = 2;		}	//initS virus-only
else if (i==14)		{	low = 1;			high = 2;		}	//initS fungus-virus
else if (i==15)		{	low = 1;			high = 2;		}	//initS control

else if (i==16)		{	low = -4;			high = -3;		}	//initV fungus-only
else if (i==17)		{	low = -4;			high = -1.3;	}	//initV virus-only
else if (i==18)		{	low = -4;			high = -1.3;	}	//initV fungus-virus
else if (i==19)		{	low = -4;			high = -3;		}	//initV control

else if (i==20)		{	low = -4;			high = -2;		}	//initR fungus-only
else if (i==21)		{	low = -4;			high = -2;		}	//initR virus-only
else if (i==22)		{	low = -4;			high = -2;		}	//initR fungus-virus
else if (i==23)		{	low = -4;			high = -2;		}	//initR control

//metapopulation three
else if (i==24)		{	low = 1;			high = 2;		}	//initS fungus-only
else if (i==25)		{	low = 1;			high = 2;		}	//initS virus-only
else if (i==26)		{	low = 1;			high = 2;		}	//initS fungus-virus
else if (i==27)		{	low = 1;			high = 2;		}	//initS control

else if (i==28)		{	low = -4;			high = -3;		}	//initV fungus-only
else if (i==29)		{	low = -4;			high = -1.3;	}	//initV virus-only
else if (i==30)		{	low = -4;			high = -1.3;	}	//initV fungus-virus
else if (i==31)		{	low = -4;			high = -3;		}	//initV control

else if (i==32)		{	low = -4;			high = -2;		}	//initR fungus-only
else if (i==33)		{	low = -4;			high = -2;		}	//initR virus-only
else if (i==34)		{	low = -4;			high = -2;		}	//initR fungus-virus
else if (i==35)		{	low = -4;			high = -2;		}	//initR control

//metapopulation four
else if (i==36)		{	low = 1;			high = 2.15;	} 	//initS
else if (i==37)		{	low = -4;			high = -1.3;	} 	//initV
else if (i==38)		{	low = -4;			high = -2;		} 	//initR

//metapopulation five
else if (i==39)		{	low = 1;			high = 2.15;	} 	//initS
else if (i==40)		{	low = -4;			high = -1.3;	} 	//initV
else if (i==41)		{	low = -4;			high = -2;		} 	//initR

//metapopulation six
else if (i==42)		{	low = 1;			high = 2.15;	} 	//initS
else if (i==43)		{	low = -4;			high = -1.3;	} 	//initV
else if (i==44)		{	low = -4;			high = -2;		} 	//initR

//conidia dispersal
else if (i==45)		{	low = -3.69;		high = 0.5;		} 	//con_mgr //rate of conidia dispersal
else if (i==46)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia

//larval dispersal
//meta 1
else if (i==47)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==48)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==49)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==50)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal

else if (i==51)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae
else if (i==52)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae
else if (i==53)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae
else if (i==54)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae

//meta 2
else if (i==55)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==56)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==57)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==58)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal

else if (i==59)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae
else if (i==60)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae
else if (i==61)		{	low = -2;			high = 0.3;		} 	//a2 //distance dispersal parameter larvae
else if (i==62)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae

//meta 3
else if (i==63)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==64)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==65)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal
else if (i==66)		{	low = -3.69;		high = 0.5;		}	//lar_mgr //rate of larval dispersal

else if (i==67)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae
else if (i==68)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae
else if (i==69)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae
else if (i==70)		{	low = -2;			high = 0.3;		}	//a2 //distance dispersal parameter larvae

//coifection
else if (i==71) 	{	low = -4;			high = 0;		}	//coinf_V //coinfecteds produce what proportion of OBs/conidia
else if (i==72) 	{	low = -4;			high = 1.7;		}	//VFSus //enhanced susceptibility 

//stochasticity
else if (i==73)		{	low = -4;			high = 0.3;		}	//Rsd_exp
else if (i==74)		{	low = -4;			high = 0.3;		}	//Fsd_exp
else if (i==75)		{	low = -4;			high = 0.3;		}	//Rsd_obs
else if (i==76)		{	low = -4;			high = 0.3;		}	//Fsd_obs

//virus 
else if (i==77)		{	low = -4;			high = 0.5;		}	//decay rate
else if (i==78)		{	low = -0.3;			high = 0.6;		}	//heterogeneity

else if (i==79)		{	low = -4;			high = -3;		} 	//fungus transmission //check this

//conidia dispersal
//meta 1
else if (i==80)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==81)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==82)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==83)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal

else if (i==84)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==85)		{	low = -2;			high = 0.3;		} 	//a //distance dispersal parameter conidia
else if (i==86)		{	low = -2;			high = 0.3;		} 	//a //distance dispersal parameter conidia
else if (i==87)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia

//meta 2
else if (i==88)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==89)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==90)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==91)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal

else if (i==92)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==93)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==94)		{	low = -2;			high = 0.3;		} 	//a //distance dispersal parameter conidia
else if (i==95)		{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia

//meta 3
else if (i==96)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==97)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==98)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal
else if (i==99)		{	low = -3.69;		high = 0.5;		}	//con_mgr //rate of conidia dispersal

else if (i==100)	{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==101)	{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==102)	{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia
else if (i==103)	{	low = -2;			high = 0.3;		}	//a //distance dispersal parameter conidia

//larval dispersal POP
else if (i==104)		{	low = -3.69;		high = 0.5;		} 	//m_l_pop
else if (i==105)		{	low = -2;			high = 0.3;		}	//a_l_pop

else if (i==106)		{	low = -4;			high = -0.5;		}  //virus transmission
...
else if (i==5)		{	step_size = 0.01;	}	//initV virus-only
else if (i==6)		{	step_size = 0.01;	}	//initV fungus-virus
...
else if (i==13)		{	step_size = 0.01;	}	//initS virus-only
else if (i==14)		{	step_size = 0.01;	}	//initS fungus-virus
...
else if (i==25)		{	step_size = 0.01;	}	//initS virus-only
else if (i==26)		{	step_size = 0.01;	}	//initS fungus-virus
...
//coifection
else if (i==71) 	{	step_size = .02;	}	//coinf_V //coinfecteds produce what proportion of OBs/conidia
else if (i==72) 	{	step_size = 0.05;	}	//VFSus //enhanced susceptibility 

//stochasticity
else if (i==73)		{	step_size = .02;	}	//Rsd_exp
else if (i==74)		{	step_size = .02;	}	//Fsd_exp
else if (i==75)		{	step_size = .02;	}	//Rsd_obs
else if (i==75)		{	step_size = .02;	}	//Fsd_obs

//virus
else if (i==77)		{	step_size = 0.05;	}	//virus decay

else if (i==78)		{	step_size = 0.002;	} 	//heterogeneity

else if (i==79)		{	step_size = 0.02;	}	//fungus transmission
