...
const double specific_muF = 0.00962435749864498;
const double Cend = 525.015699999847; //these are based on multi-year dynamics
...
const double size_C = 1; //PLACEHOLDER VALUES
const double indexR = 0;
const double indexV = 0;

const double lambdaF = 0.119701349994476;
const double lambdaV = 1/16;
