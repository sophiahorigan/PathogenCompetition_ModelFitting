...
if(reals==1){
	...
	Params.FITINIT[1][8] = 0.07092; //initR
	...
	Params.FITINIT[2][8] = 0.0000000000000000001; //initR
	Params.FITINIT[2][9] = 0.0000000000000000001;//initR
	Params.FITINIT[2][10] = 0.0000000000000000001; //initR
	Params.FITINIT[2][11] = 0.03426; //initR
	...
	Params.FITINIT[3][8] = 0.03084; //initR
	Params.FITINIT[3][9] = 0.0000000000000000001; //initR
	Params.FITINIT[3][10] = 0.0000000000000000001; //initR
	Params.FITINIT[3][11] = 0.0000000000000000001; //initR
	...
	Params.con_mgr 		= .99;
	Params.a 			= 0.00000000000000000001;
	Params.lar_mgr 		= .9999;
