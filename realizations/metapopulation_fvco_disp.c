...
if(reals==1){
	...
	Params.FITINIT[1][5] = 0.0002; //initV
	Params.FITINIT[1][6] = 0.0002; //initV
	...
	Params.FITINIT[2][5] = 0.0002; //initV
	Params.FITINIT[2][6] = 0.0002; //initV
	...
	Params.FITINIT[3][5] = 0.0002; //initV
	Params.FITINIT[3][6] = 0.0002; //initV
